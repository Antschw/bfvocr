...
public class Tess4JOcrService implements OcrService {
   ...
   */
  @Inject
  public Tess4JOcrService(ImagePreprocessor preprocessor, OcrConfig config, TessdataProvider tessdataProvider) {
  ...
  protected void setupTesseract() {
    try {
      ...
      try (InputStream is = getTessdataStream(); OutputStream os = new FileOutputStream(traineddataFile)) {
